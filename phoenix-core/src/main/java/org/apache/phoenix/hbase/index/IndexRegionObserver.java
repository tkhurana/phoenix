...
public class IndexRegionObserver extends CompatIndexRegionObserver {
  ...
  private List<Mutation> generateOnDupMutations(BatchMutateContext context, Put atomicPut) throws IOException {
      ...
      // Get below is used to store the columns that need to be read in the conditional expressions
      // This Get is applied to the current data row state to read the column values
    ...
    private List<Cell> readColumnsFromRow(Put currentDataRow, Get get) {
