...
public class CompactionScanner implements InternalScanner {
    ...
    private void postProcessForConditionalTTL(List<Cell> result) {
        ...
        ConditionalTTLExpression ttlExpr = (ConditionalTTLExpression) rowContext.ttlExprForRow;
    ...
    class RowContext {
        ...
        public boolean hasConditionalTTL() {
            return ttlExprForRow != null && ttlExprForRow instanceof ConditionalTTLExpression;
        }
